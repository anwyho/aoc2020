# This file is just a bunch of Python code I crammed into one line just as an exercise. 
# There's also anonymous recursion, meaning recursion without a reference to the recursive method. 
# A lot of this is just scratch code, so please don't see this as Python code I'm proud of, in terms of organization and code cleanliness. 
